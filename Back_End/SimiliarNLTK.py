...
#----------------------------------------------------
# processing for description and noun of products
#----------------------------------------------------
...
#-----------------------------------------------------------------------------------
# calcul the total probabilty and take the 10 similar products for each product
#-----------------------------------------------------------------------------------
...
save_data("C:/Users/abd/OneDrive/Bureau/PFE_FILES_FIN/silimiarproducts.xlsx",Similiar)